...
1. Inspect the repository's language, dependencies, model-call path, context construction, async model, tests, configuration, and telemetry conventions. Use the workspace's search and file-listing tools first.
